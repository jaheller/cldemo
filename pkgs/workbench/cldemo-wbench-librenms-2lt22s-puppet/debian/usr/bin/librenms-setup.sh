...
/usr/bin/php /var/www/librenms/addhost.php leaf2.lab.local public v2c
/usr/bin/php /var/www/librenms/addhost.php spine1.lab.local public v2c
/usr/bin/php /var/www/librenms/addhost.php spine2.lab.local public v2c
